...
def cargar_paises():
    ...
    with open("datos_paises.csv", newline="", encoding="utf-8") as archivo:
        ...
        # Iterar sobre cada fila del CSV y agregar a la lista de libros
        for fila in lector:
...
def agregar_pais():
    ...
    nombre_pais = input(
        "\nIngrese el nombre del país que desea agregar (o 'salir' para volver al menú): "
    ).strip()
    # Verificamos si el usuario desea salir
    if nombre_pais.lower() == "salir":
        print("Regresando al menú principal...")
...
def actualizar_pais():
    ...
    # Solicitamos al usuario el nombre del país a actualizar
    nombre_pais = input(
        "\nIngrese el nombre del país que desea actualizar (o 'salir' para volver al menú): "
    ).strip()
    # Verificamos si el usuario desea salir
    if nombre_pais.lower() == "salir":
        print("Regresando al menú principal...")
    ...
    for pais in paises:
        if pais["nombre"].lower() == nombre_pais.lower():
            ...
            nueva_poblacion = input(
                f"Ingrese la nueva población (actual: {pais['poblacion']}): "
            ).strip()
            nueva_superficie = input(
                f"Ingrese la nueva superficie (actual: {pais['superficie']}): "
            ).strip()
...
def eliminar_pais():
    ...
    nombre_pais = input(
        "\nIngrese el nombre del país que desea eliminar (o 'salir' para volver al menú): "
    ).strip()
    # Verificamos si el usuario desea salir
    if nombre_pais.lower() == "salir":
        print("Regresando al menú principal...")
